...
function setup() {
  ...
  let input = createInput("Il Mheg");
  input.parent(label);
  input.input(() => {
    rebuildWorld(input.value());
  });

  createP("Arrow keys scroll. Click to place stuff! By default place Grass, or hold C for Crystals, or T for Trees").parent("container");
